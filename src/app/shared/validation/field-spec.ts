...
function finalizeValidationResult(result: { [key: string]: boolean }): { [key: string]: boolean } | null {
...
export class FieldSpecs {
  ...
  static passwordValidator(control: AbstractControl): {[key: string]: any} | null {
    ...
    return finalizeValidationResult({ passwordRequired, passwordAlphabeticChars, passwordNonAlphabetucChars, passwordMinLength });
  }

  static profileLocationValidator(control: AbstractControl): {[key: string]: any} | null {
    ...
    return finalizeValidationResult({ profileLocationRequired, profileLocationMaxLength });
  }

  static profileBioValidator(control: AbstractControl): {[key: string]: any} | null {
